                         ...
                         <div class="col-lg-12 col-md-12">
                             <div class="service-link">   
                                   <ul>
                                        <li>
                                            <div class="s-link">
                                                 <div class="text"><a href="{{ url('') }}/single-service.html"><h3><i class="fal fa-long-arrow-right"></i> Cafe & Wine Bar</h3> <span>Start from <b>$150</b></span></a></div>
                                       ...
                                       <li>
                                           ...
                                           <div class="text"> <a href="{{ url('') }}/single-service.html"><h3><i class="fal fa-long-arrow-right"></i> Spa & Wellness</h3> <span>Start from <b>$100</b></span></a></div>
                                            <div class="layer img-hover"><img src="{{ url('') }}/assets/img/bg/sr-img-02.png" alt="shape"></div>
                                           </div>
                                        </li>  
                                       <li>
                                           <div class="s-link">
                                               <div class="text"> <a href="{{ url('') }}/single-service.html"><h3><i class="fal fa-long-arrow-right"></i> Restaurant</h3> <span>Start from <b>$130</b></span></a></div>
                                               <div class="layer img-hover"><img src="{{ url('') }}/assets/img/bg/sr-img-03.png" alt="shape"></div>
                                           </div>
                                        </li>  
                                      <li>
                                          <div class="s-link">
                                               <div class="text"><a href="{{ url('') }}/single-service.html"><h3><i class="fal fa-long-arrow-right"></i> Meetings & Events</h3> <span>Start from <b>$140</b></span></a></div>
                     ...
                     <div class="row">
                        <div class="col-lg-2 col-sm-6">
                            <div class="instagram-box">
                                ...
                                <div class="hover"><a href="{{ url('') }}/#"><img src="{{ url('') }}/assets/img/icon/instagram-icon.png" alt="img"></a></div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6">
                            <div class="instagram-box">
                       ...
                       <div class="col-lg-4 col-md-6">
                            <div class="single-post2 hover-zoomin mb-30 wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="{{ url('') }}/blog-details.html"><img src="{{ url('') }}/assets/img/blog/inner_b1.jpg" alt="img"></a>
                                </div>                    
                                <div class="blog-content2">                                     
                                    ...
                                    <h4><a href="{{ url('') }}/blog-details.html">Cras accumsan nulla nec lacus ultricies placerat.</a></h4>                                    
                                    <div class="blog-btn"><a href="{{ url('') }}/blog-details.html">Read More</a></div>
                         ...
                         <div class="col-lg-4 col-md-6">
                            <div class="single-post2 mb-30 hover-zoomin wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="{{ url('') }}/blog-details.html"><img src="{{ url('') }}/assets/img/blog/inner_b2.jpg" alt="img"></a>
                                </div>
                                <div class="blog-content2">                                    
                                    <div class="date-home">
                                       24th March 2024
                                    ...
                                    <h4><a href="{{ url('') }}/blog-details.html">Dras accumsan nulla nec lacus ultricies placerat.</a></h4>                                   
                                    <div class="blog-btn"><a href="{{ url('') }}/blog-details.html">Read More</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="single-post2 mb-30 hover-zoomin wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="{{ url('') }}/blog-details.html"><img src="{{ url('') }}/assets/img/blog/inner_b3.jpg" alt="img"></a>
                                </div>
                                <div class="blog-content2">                                    
                                    <div class="date-home">
                                        24th March 2024
                                    ...
                                    <h4><a href="{{ url('') }}/blog-details.html">Seas accumsan nulla nec lacus ultricies placerat.</a></h4>                                    
                                    <div class="blog-btn"><a href="{{ url('') }}/blog-details.html">Read More</a></div>
                                </div>
                            </div>
                        </div>
