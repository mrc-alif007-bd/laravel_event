            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content search-popup">
                    <div class="text-center">
                        <a href="{{ url('') }}/assets/#" class="close2" data-dismiss="modal" aria-label="Close">×
                            close</a>
                    </div>
                    <div class="row search-outer">
                        <div class="col-md-11"><input type="text" placeholder="Search for products..." /></div>
                        <div class="col-md-1 text-right"><a href="{{ url('') }}/assets/#"><i class="fa fa-search"
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a
                                                    href="{{ url('') }}/assets/index.html">Home</a></li>
                    ...
                    <div class="col-lg-8">
                        <div class="bsingle__post mb-50">
                            <div class="bsingle__post-thumb">
                                <img src="{{ url('') }}/assets/img/blog/inner_b1.jpg" alt="">
                            </div>
                            <div class="bsingle__content">
                                ...
                                <h2><a href="{{ url('') }}/assets/blog-details.html">Lorem ipsum dolor sit amet,
                                        consectetur
                                ...
                                <div class="blog__btn">
                                    <a href="{{ url('') }}/assets/#">Read More</a>
                                </div>
                            </div>
                        </div>
                        <div class="bsingle__post mb-50">
                            <div class="bsingle__post-thumb video-p">
                                <img src="{{ url('') }}/assets/img/blog/inner_b2.jpg" alt="">
                                <a href="{{ url('') }}/assets/https://www.youtube.com/watch?v=gyGsPlt06bo"
                            ...
                            <div class="bsingle__content">
                                ...
                                <h2><a href="{{ url('') }}/assets/blog-details.html">There are many variations
                        ...
                        <div class="bsingle__post mb-50">
                            <div class="bsingle__post-thumb blog-active">
                                <div class="slide-post">
                                    <img src="{{ url('') }}/assets/img/blog/inner_b3.jpg" alt="">
                                </div>
                                <div class="slide-post">
                                    <img src="{{ url('') }}/assets/img/blog/inner_b2.jpg" alt="">
                                </div>
                            ...
                            <div class="bsingle__content">
                                ...
                                <h2><a href="{{ url('') }}/assets/blog-details.html">I must explain to you how
                        ...
                        <div class="pagination-wrap">
                            <nav>
                                <ul class="pagination">
                                    <li class="page-item"><a href="{{ url('') }}/assets/#"><i
                                                class="fas fa-angle-double-left"></i></a></li>
                                    <li class="page-item active"><a href="{{ url('') }}/assets/#">1</a></li>
                                    <li class="page-item"><a href="{{ url('') }}/assets/#">2</a></li>
                                    <li class="page-item"><a href="{{ url('') }}/assets/#">3</a></li>
                                    <li class="page-item"><a href="{{ url('') }}/assets/#">...</a></li>
                                    <li class="page-item"><a href="{{ url('') }}/assets/#">10</a></li>
                                    <li class="page-item"><a href="{{ url('') }}/assets/#"><i
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4">
                        <aside class="sidebar-widget">
                            ...
                            <section id="custom_html-5" class="widget_text widget widget_custom_html">
                                ...
                                <div class="textwidget custom-html-widget">
                                    <div class="widget-social">
                                        ...
                                        <a href="{{ url('') }}/assets/#"><i class="fab fa-pinterest-p"></i></a>
                                        <a href="{{ url('') }}/assets/#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="{{ url('') }}/assets/#"><i class="fab fa-instagram"></i></a>
                                        <a href="{{ url('') }}/assets/#"><i class="fab fa-wordpress"></i></a>
                                    </div>
                                </div>
                            </section>
                            <section id="categories-1" class="widget widget_categories">
                                ...
                                <ul>
                                    <li class="cat-item cat-item-16"><a
                                            href="{{ url('') }}/assets/#">Branding</a> (4)</li>
                                    <li class="cat-item cat-item-23"><a
                                            href="{{ url('') }}/assets/#">Corporat</a> (3)</li>
                                    <li class="cat-item cat-item-18"><a
                                            href="{{ url('') }}/assets/#">Design</a> (3)</li>
                                    <li class="cat-item cat-item-22"><a
                                            href="{{ url('') }}/assets/#">Gallery</a> (3)</li>
                                </ul>
                            </section>
                            <section id="recent-posts-4" class="widget widget_recent_entries">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ url('') }}/assets/#">User Experience Psychology And
                                            Performance Smshing</a>
                                        <span class="post-date">August 19, 2020</span>
                                    </li>
                                    <li>
                                        <a href="{{ url('') }}/assets/#">Monthly Web Development Up Cost Of
                                            JavaScript</a>
                                        <span class="post-date">August 19, 2020</span>
                                    </li>
                                    <li>
                                        <a href="{{ url('') }}/assets/#">There are many variation passages of
                                            like available.</a>
                                        <span class="post-date">August 19, 2020</span>
                                    </li>
                                </ul>
