...
<head>
    ...
    <link href="frontend/css/base.css" rel="stylesheet" type="text/css" media="all" />
    <link href="frontend/css/main.css" rel="stylesheet" type="text/css" media="all" />
    <link href="frontend/css/flexslider.css" rel="stylesheet" type="text/css" media="all" />
    <link href="frontend/css/venobox.css" rel="stylesheet" type="text/css" media="all" />
    <link href="frontend/css/fonts.css" rel="stylesheet" type="text/css" media="all" />
    <link href="frontend/https://fonts.googleapis.com/css?family=Work+Sans:300,400,500,600,700" rel="stylesheet">
    <link href="frontend/https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,700" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="hero overlay">
            ...
            <header class="header">
                ...
                <div class="container ">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <a class="scroll logo" href="frontend/#wrapper">
                                <h2>events</h2>
                            </a>
                        </div>
                        <div class="col-md-10 text-right">
                            <nav class="main-nav">
                                <div class="toggle-mobile-but">
                                    <a href="frontend/#" class="mobile-but">
                                        <div class="lines"></div>
                                    </a>
                                </div>
                                <ul>
                ...
                <div class="container hero-content">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <h3 class="mb-10">Conference of</h3>
                            <h1 class="large mb-10">Digital Photography</h1>
                            <p class="uppercase ">27 to 31 July 2017 with over 80 sessions - Cincinnati, Ohio </p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 mb-100 text-center">
                        <h1 class="title">Conference Of Digital Photography</h1>
                        <p class="title-lead mt-20">Nihilne te nocturnum praesidium Palati, nihil urbis vigilae, nihil
                            timor populi, nihil concursus velit omnium, nihil hic muntissimus habendi senatus locus,
                            nihil horum ora vultusque moverunt, patere tua consilia non sentis constrictam nihil hic
                            muntissimus.</p>
                    </div>
                </div>
                <!--End row-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        <div class="block-info-1">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                height="25px" viewBox="0 0 42 32" enable-background="new 0 0 42 32"
                                xml:space="preserve">
                                <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="5.1983"
                                    y1="28.1187" x2="43.4067" y2="11.702">
                              ...
                              C37.327,32,38,31.327,38,30.5z" />
                                <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="4.7162"
                                    y1="26.9965" x2="42.9245" y2="10.5799">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                              ...
                              M24,18v5h-6v-5H24z M11,18h6v5h-6V18z" />
                                <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="-0.4811"
                                    y1="14.9003" x2="37.7272" y2="-1.5164">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                              ...
                              C32.224,2,32,2.224,32,2.5S32.224,3,32.5,3z" />
                                <linearGradient id="SVGID_4_" gradientUnits="userSpaceOnUse" x1="-1.6311"
                                    y1="12.2237" x2="36.5772" y2="-4.1929">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                                <path fill="url(#SVGID_4_)" d="M26.5,3C26.776,3,27,2.776,27,2.5S26.776,2,26.5,2h-11C15.224,2,15,2.224,15,2.5S15.224,3,15.5,3
                              H26.5z" />
                                <linearGradient id="SVGID_5_" gradientUnits="userSpaceOnUse" x1="-2.9557"
                                    y1="9.1407" x2="35.2526" y2="-7.2759">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                                <path fill="url(#SVGID_5_)"
                                    d="M13,4.5v-4C13,0.224,12.776,0,12.5,0S12,0.224,12,0.5v4C12,4.776,12.224,5,12.5,5S13,4.776,13,4.5z" />
                                <linearGradient id="SVGID_6_" gradientUnits="userSpaceOnUse" x1="-0.3065"
                                    y1="15.3067" x2="37.9019" y2="-1.11">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                            ...
                            <p>
                                <strong>DATE</strong>
                                <span>27 until 31 July 2017</span>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <div class="block-info-1">
                            <svg version="1.1" id="Layer_7" xmlns="http://www.w3.org/2000/svg"
                                ...
                                height="25px" viewBox="0 0 42 32" enable-background="new 0 0 42 32"
                                xml:space="preserve">
                                <linearGradient id="SVGID_7_" gradientUnits="userSpaceOnUse" x1="4.511"
                                    y1="11.8158" x2="41.3229" y2="27.6695">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                              ...
                              c-0.142,0.059-0.249,0.178-0.29,0.326l-4.984,17.5c-0.062,0.216,0.028,0.446,0.22,0.563L10.239,31.926z" />
                                <linearGradient id="SVGID_8_" gradientUnits="userSpaceOnUse" x1="12.6241"
                                    y1="7.5582" x2="28.5468" y2="14.4156">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                              ...
                              C14,4.223,17.225,0.999,21.5,0.999z" />
                                <linearGradient id="SVGID_9_" gradientUnits="userSpaceOnUse" x1="17.3671"
                                    y1="6.7191" x2="25.6329" y2="10.2789">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="block-info-1">
                            <svg version="1.1" id="Layer_10" xmlns="http://www.w3.org/2000/svg"
                                ...
                                height="25px" viewBox="0 0 42 32" enable-background="new 0 0 42 32"
                                xml:space="preserve">
                                <linearGradient id="SVGID_10_" gradientUnits="userSpaceOnUse" x1="1.9027"
                                    y1="28.6566" x2="55.9027" y2="10.9483">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                              ...
                              C40.998,0.224,40.774,0,40.498,0z" />
                                <linearGradient id="SVGID_14_" gradientUnits="userSpaceOnUse" x1="1.1102"
                                    y1="26.2399" x2="55.1102" y2="8.5316">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                              ...
                              c10.237,0,15.392-3.864,18.498-6.316V29.317z" />
                                <linearGradient id="SVGID_11_" gradientUnits="userSpaceOnUse" x1="-1.8839"
                                    y1="17.1097" x2="52.1161" y2="-0.5987">
                                    <stop offset="0" style="stop-color:#399BFF" />
                                    <stop offset="1" style="stop-color:#EE71F9" />
                                </linearGradient>
                    ...
                    <div class="col-md-3 col-sm-3 text-right">
                        <div class="block-info-1">
                            <a href="frontend/#tickets" class="scroll but"> Buy Tickets Now</a>
                        </div>
                    </div>
                </div>
                <!--End row-->
            ...
            <div class="block-content">
                    ...
                    <div class="block-speaker">
                        <div class="block-img overlay soft">
                            ...
                            <div class="block-info-2">
                                <p>
                                    <strong>Lina Blamberg</strong>
                                    <span>Photographer </span>
                                </p>
                                <ul class="block-social">
                                    <li><a href="frontend/#"><i class="icon-twitter"></i></a></li>
                                    <li><a href="frontend/#"><i class="icon-linkedin"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-3 pd-0">
                    <div class="block-speaker">
                        <div class="block-img overlay soft">
                            <div class="background-img">
                                <img src="frontend/img/5.jpg" alt="">
                            </div>
                            <div class="block-info-2">
                                <p>
                                    <strong>Emilie Lippelt</strong>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 mb-100 text-center">
                        ...
                        <p class="title-lead mt-10">Whether you’re new to the speaking field or a seasoned pro you’ll
                            connect<br> with old colleagues and make valuable new friends.</p>
                    </div>
                </div>
                <!--End row-->
            </div>
                ...
                <div class="row vertical-align">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="block-video">
                            <iframe
                                src="frontend/http://player.vimeo.com/video/16334844?color=ffffff&portrait=0"></iframe>
                        </div>
                    </div>
                </div>
                <!--end of row-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 mb-100 text-center">
                        ...
                        <p class="title-lead mt-10">We are very excited about the program being planned for Events 2017
                            <br> this summer in Cincinati, Ohio.</p>
                    </div>
                </div>
                <!--End row-->
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-4 ">
                        <!--Tabs-->
                        <ul class="block-tabs">
                            <li class="active"><i class="et-line-calendar"></i><strong>Day 1</strong> <span>- 23 july
                                    2017</span></li>
                            <li class=""><i class="et-line-calendar"></i><strong>Day 2</strong> <span>- 24 july
                                    2017</span></li>
                            <li class=""><i class="et-line-calendar"></i><strong>Day 3</strong> <span>- 25 july
                                    2017</span></li>
                            <li class=""><i class="et-line-calendar"></i><strong>Day 4</strong> <span>- 26 july
                                    2017</span></li>
                        </ul>
                        <a class="link mt-20 gradient-text scroll" href="frontend/#accom">Accommodation</a>
                    </div>
                    <div class="col-sm-8 ">
                        <ul class="block-tab">
                            <!--Tab-->
                            <li class="active ">
                                <div class="block-date"><i class="et-line-calendar"></i><strong>Day 1</strong> <span>-
                                        23 july 2017</span></div>
                                <div class="block-detail">
                                    <span class="time">08:00 - 10:00</span>
                                    <span class="topic">Conference Opening</span>
                                    <div class="block-text">
                                        <p>Nihilne te nocturnum praesidium Palati, nihil urbis vigilae, nihil timor
                                            populi, nihil concursus velit omnium, nihil hic muntissimus habendi senatus
                                            locus, nihil horum ora vultusque moverunt, patere tua consilia non sentis
                                            constrictam nihil hic muntissimus.</p>
                                        <span class="speaker"> <strong>Speaker</strong> : <a href="frontend/#"
                                                class="gradient-text ">Adam Blanco</a> </span>
                                    </div>
                                </div>
                                <div class="block-detail">
                                    ...
                                    <div class="block-text">
                                        <p>Nihilne te nocturnum praesidium Palati, nihil urbis vigilae, nihil timor
                                            ...
                                            constrictam nihil hic muntissimus.</p>
                                        <span class="speaker"> <strong>Speaker</strong> : <a href="frontend/#"
                                                class="gradient-text ">Luca Palermo</a> </span>
                                    </div>
                                </div>
                                <div class="block-detail">
                                ...
                                <div class="block-detail">
                                    ...
                                    <div class="block-text">
                                        <p>Nihilne te nocturnum praesidium Palati, nihil urbis vigilae, nihil timor
                                            ...
                                            constrictam nihil hic muntissimus.</p>
                                        <span class="speaker"> <strong>Speaker</strong> : <a href="frontend/#"
                                                class="gradient-text "> Lina Blamberg </a> </span>
                                    </div>
                                </div>
                                <div class="block-detail">
                                ...
                                <div class="block-detail">
                                    ...
                                    <div class="block-text">
                                        <p>Nihilne te nocturnum praesidium Palati, nihil urbis vigilae, nihil timor
                                            ...
                                            constrictam nihil hic muntissimus.</p>
                                        <span class="speaker"> <strong>Speaker</strong> : <a href="frontend/#"
                                                class="gradient-text "> Emilie Lippelt </a> </span>
                                    </div>
                                </div>
                            </li>
                            <!--Tab-->
                            <li>
                                <div class="block-date"><i class="et-line-calendar"></i><strong>Day 2</strong> <span>-
                            ...
                            <!--Tab-->
                            <li>
                                <div class="block-date"><i class="et-line-calendar"></i><strong>Day 3</strong> <span>-
                                        25 july 2017</span></div>
                                <div class="block-detail">
                                    <span class="time">08:00 - 10:00</span>
                            ...
                            <!--Tab-->
                            <li>
                                <div class="block-date"><i class="et-line-calendar"></i><strong>Day 4</strong> <span>-
                                        26 july 2017</span></div>
                                <div class="block-detail">
                                    <span class="time">08:00 - 10:00</span>
        ...
        <section class="counter pt-120 pb-120 overlay parallax">
            <div class="background-img">
                <img src="frontend/img/6.jpg" alt="">
            </div>
            <!--Container-->
            <div class="container">
                <!--Row-->
                <div class="row">
                    <div class="col-sm-12  text-center  front-p">
                        ...
                        <p class="title-lead mt-10 mb-20">27 to 31 July 2017 with over 80 sessions - Cincinnati, Ohio
                        </p>
        ...
        <section id="tickets" class="tickets pt-120 pb-120">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 mb-130 text-center">
                        ...
                        <p class="title-lead mt-10">If you want more bookings, then reserve your e-ticket for the ride
                            of the year <br> Come join the world’s influencers and get answers. </p>
                    </div>
                </div>
                <!--End row-->
            </div>
            ...
            <div class="container">
                ...
                <div class="row vertical-align tickets">
                    <div class="col-sm-4 ">
                        <h3 class="sub-title-0  mb-20"><span class="gradient-text">Your first conference</span><br>
                            <span class="gradient-text">day is for free</span>
                        </h3>
                        <div class="review-slider flexslider">
                            <ul class="slides">
                                <li>
                                    <blockquote>“ It’s an unlikely setting for an exquisite dining experience—served up
                                        by a couple straight out of a rom-com plot.“ </blockquote>
                                </li>
                                <li>
                                    <blockquote>“ The food is plentiful and delicious, it is all part of the "old world"
                                        sort of dining experience.“ </blockquote>
                                </li>
                                <li>
                                    <blockquote>“ Huge portions, great food, fast service. This location obviously is
                                        always packed due to being in Times Sq.“ </blockquote>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul class="block-tickets overlap">
                                <li>
                                    <ul class="block-ticket ">
                                        <li class="block-price"><span class="price"><span
                                                    class="cur">$</span>120</span><span class="block-type">1 Days
                                                ticket</span></li>
                                        <li>Main Event speeche</li>
                                        <li>Limited areas access</li>
                                        <li>Lunch on day 1</li>
                                        <li><a href="#register" class="but mt-30"> Buy Ticket Now</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="block-tickets">
                                <li>
                                    <ul class="block-ticket active">
                                        <li class="block-price"><span class="price"><span
                                                    class="cur">$</span>590</span><span class="block-type">All Days
                                                ticket</span></li>
        ...
        <section id="register" class="register pt-120 pb-120 overlay">
            <div class="background-img ">
                <img src="frontend/img/7.jpg" alt="">
            </div>
            <!--Container-->
            <div class="container">
                <!--Row-->
                <div class="row">
                    <div class="col-md-6 front-p">
                        <form class="registry-form form" method="post" action="{{ route('store') }}">
                            @csrf
                            <h2 class="sub-title-1 mb-30">Register your coming at Events Conference July 2017</h2>
                            <div class="col-sm-6">
                                <input placeholder="Your Name" value="{{ old('name') }}" id="name"
                            ...
                            <div class="col-sm-6">
                                <input placeholder="Your Email" value="{{ old('email') }}" id="email"
                            ...
                            <div class="col-sm-6">
                                <input placeholder="Phone number" value="{{ old('phone') }}" id="phone"
                            ...
                            <div class="col-sm-6">
                                <input placeholder="Number of tickets"  value="{{ old('ticket') }}" id="ticket"
                                    ...
                                    <select name="event_name" class="form-select" required>
                                        ...
                                        @foreach ($events as $event)
                                            <option value="{{ $event->id }}"
                                                {{ old('event_name') == $event->id ? 'selected' : '' }}>
                                                {{ $event->title }}
                                            </option>
                                        @endforeach
                                    </select>
            ...
            <div class="container block-contact">
                ...
                <div class="row">
                    <div class="col-md-5 col-md-offset-7 col-sm-5 col-sm-offset-7">
                        ...
                        <p class="title-lead mt-10 mb-50">Dear guests, you are welcomed to dine with us at Tasty
                    ...
                    <div class="col-md-5 col-md-offset-7 col-sm-5 col-sm-offset-7">
                        <div class="block-info-3">
                            <p>
                                ...
                                Fax: (513) 352-6220 <br>
                                Email : <a href="frontend/mailto:contact@events.com"
                                    class="gradient-text">contact@events.com</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 mb-100 text-center ">
                        ...
                        <p class="title-lead mt-10 mb-20">Accommodation and travel info - information below or email us
                            for further help.</p>
                    </div>
                </div>
                <!--End row-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-2 text-center">
                        <div class="block-img">
                            <div class="background-img">
                                <img alt="" src="frontend/img/8.jpg" style="display: none;">
                            </div>
                        </div>
                        <p class="mt-30">Hotel Monaco <br>
                            501 Geary Street<br>
                            San Franciscio, California<br>
                            (415) 292 - 0100
                        </p>
                        <a href="frontend/#" class="link gradient-text mt-30">
                            Location
                        </a>
                    </div>
                    <div class="col-sm-4 text-center">
                        <div class="block-img">
                            <div class="background-img">
                                <img alt="" src="frontend/img/9.jpg" style="display: none;">
                            </div>
                        </div>
                        <p class=" mt-30 ">Hotel Nikko<br>
                            222 Mason Street<br>
                            San Franciscio, California<br>
                            (415) 394 - 1111
                        </p>
                ...
                <div class="row mt-100">
                    <div class="col-sm-4 col-sm-offset-2 text-center">
                        <div class="block-img">
                            <div class="background-img">
                                <img alt="" src="frontend/img/10.jpg" style="display: none;">
                            </div>
                        </div>
                        <h2 class="sub-title-2 mt-30">Air Transport</h2>
                        <p class="mt-10">Ad mortem te, Catalina, duci iussu consulis iam pridem oportebat, in te
                            conferri pestem quam tu in nos omnes iam diu machinaris ac vitamus.
                        </p>
                    </div>
                    <div class="col-sm-4 text-center">
                        <div class="block-img">
                            <div class="background-img">
                                <img alt="" src="frontend/img/11.jpg" style="display: none;">
                            </div>
                        </div>
                        <h2 class="sub-title-2 mt-30">Ground Transport</h2>
                        <p class=" mt-10 ">Ad mortem te, Catalina, duci iussu consulis iam pridem oportebat, in te
                            conferri pestem quam tu in nos omnes iam diu machinaris ac vitamus.
                        </p>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2  ">
                        <div class="block-faq mb-50">
                            ...
                            <p>Web marketing refers to a broad category of advertising that takes many different forms,
                                but generally involves any marketing activity conducted online. Marketers have shifted
                                their efforts online because it tends to be significantly less expensive.</p>
                        </div>
                        <div class="block-faq mb-50">
                            <h4 class="mb-10">What is digital advertising ?</h4>
                            <p>Digital advertising, also called Internet advertising ("Internet marketing") is when
                        ...
                        <div class="block-faq mb-50">
                            ...
                            <p>Internet marketing, or online marketing, refers to advertising and marketing efforts that
                                use the Web and email to drive direct sales via electronic commerce, in addition to
                                sales leads from Web sites or emails. Internet marketing and online advertising efforts
                                are typically used in conjunction with traditional.</p>
                        </div>
                    </div>
                </div>
                <!--End row-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2  text-center mt-50">
                        ...
                        <p><a class="gradient-text" href="frontend/mailto:contact@events.com ">contact@events.com</a>
                        </p>
                    </div>
                </div>
                <!--End row-->
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 mb-130 ">
                        <svg version="1.1" id="Layer_12" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <linearGradient id="SVGID_12_" gradientUnits="userSpaceOnUse" x1="0.9386"
                                y1="24.9189" x2="42.6053" y2="8.5439">
                                <stop offset="0" style="stop-color:#399BFF" />
                                <stop offset="1" style="stop-color:#EE71F9" />
                            </linearGradient>
                           ...
                           C40.327,7,41,7.673,41,8.5V13H32.75z" />
                            <linearGradient id="SVGID_13_" gradientUnits="userSpaceOnUse" x1="-5.5546"
                                y1="8.3968" x2="36.1121" y2="-7.9782">
                                <stop offset="0" style="stop-color:#399BFF" />
                                <stop offset="1" style="stop-color:#EE71F9" />
                            </linearGradient>
                           ...
                           C3,4.776,3.224,5,3.5,5S4,4.776,4,4.5v-1C4,3.224,4.225,3,4.5,3h4C8.775,3,9,3.224,9,3.5v1C9,4.776,9.224,5,9.5,5z" />
                            <linearGradient id="SVGID_15_" gradientUnits="userSpaceOnUse" x1="1.6076"
                                y1="26.6212" x2="43.2743" y2="10.2462">
                                <stop offset="0" style="stop-color:#399BFF" />
                                <stop offset="1" style="stop-color:#EE71F9" />
                            </linearGradient>
                        ...
                        <p class="title-lead mt-5">For more photo and video visit our socials hubs.</p>
                    </div>
                </div>
                <!--End row-->
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12 ">
                        <ul class="block-gallery">
                            <li class="col-sm-2 ">
                                <a href="frontend/img/12.jpg" class="venobox">
                                    <div class="block-img">
                                        <div class="background-img">
                                            <img alt="" src="frontend/img/12.jpg" style="display: none;">
                                        </div>
                                    </div>
                                </a>
                            </li>
                            <li class="col-sm-2 ">
                                <a href="frontend/img/13.jpg" class="venobox">
                                    <div class="block-img">
                                        <div class="background-img">
                                            <img alt="" src="frontend/img/13.jpg" style="display: none;">
                                        </div>
                                    </div>
                                </a>
                            </li>
                            <li class="active col-sm-2 ">
                                <a href="frontend/img/14.jpg" class="venobox">
                                    <div class="block-img">
                                        <div class="background-img">
                                            <img alt="" src="frontend/img/14.jpg" style="display: none;">
                                        </div>
                                    </div>
                                </a>
                            </li>
                            <li class="col-sm-2 ">
                                <a href="frontend/img/15.jpg" class="venobox">
                                    <div class="block-img">
                                        <div class="background-img">
                                            <img alt="" src="frontend/img/15.jpg" style="display: none;">
                                        </div>
                                    </div>
                                </a>
                            </li>
                            <li class="col-sm-2 ">
                                <a href="frontend/img/16.jpg" class="venobox">
                                    <div class="block-img">
                                        <div class="background-img">
                                            <img alt="" src="frontend/img/16.jpg" style="display: none;">
                                        </div>
                                    </div>
                                </a>
                            </li>
                            <li class="col-sm-2 ">
                                <a href="frontend/img/17.jpg" class="venobox">
                                    <div class="block-img">
                                        <div class="background-img">
                                            <img alt="" src="frontend/img/17.jpg" style="display: none;">
                                        </div>
                                    </div>
                                </a>
                            </li>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                            <form method="post" class="subscribe-form form" action="#">
                                <div class="col-sm-8">
                                    <input placeholder="Enter your email address" value="" id="user-name"
                                        name="name" type="text">
                                </div>
                                <div class="col-sm-4">
                ...
                <div class="container ">
                    <div class="row">
                        <div class="col-sm-4 col-sm-offset-2">
                            ...
                            <p class="">Ad mortem te, Catalina, duci iussu consulis iam pridem oportebat, in te
                                conferri pestem quam tu in nos omnes iam diu machinaris ac vitamus. </p>
                            <ul class="block-social mt-20">
                                <li><a href="frontend/#"><i class="icon-facebook"></i></a></li>
                                <li><a href="frontend/#"><i class="icon-twitter"></i></a></li>
                                <li><a href="frontend/#"><i class="icon-youtube"></i></a></li>
                                <li><a href="frontend/#"><i class="icon-gplus"></i></a></li>
                                <li><a href="frontend/#"><i class="icon-instagram-1"></i></a></li>
                            </ul>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 ">
                            <ul class="block-legal">
                                <li><a href="frontend/#">Privacy Policy</a>
                                <li><a href="frontend/#">Terms of Use</a></li>
                                <li><a href="frontend/#">About</a></li>
                                <li><a href="frontend/#">Legal</a></li>
                                <li><span><a class="gradient-text scroll" href="frontend/#wrapper">Back To
                                            Top</a></span></li>
                            </ul>
                        </div>
                    </div>
    ...
    <!-- End wrapper-->
    <!--Javascript-->
    <script src="frontend/js/jquery-1.12.4.min.js" type="text/javascript"></script>
    ...
    <script src="frontend/js/smooth-scroll.js" type="text/javascript"></script>
    <script src="frontend/js/jquery.validate.min.js" type="text/javascript"></script>
    <script src="frontend/js/placeholders.min.js" type="text/javascript"></script>
    <script src="frontend/js/venobox.min.js" type="text/javascript"></script>
    <script src="frontend/js/instafeed.min.js" type="text/javascript"></script>
    <script src="frontend/js/script.js" type="text/javascript"></script>
    <script
        src="frontend/https://maps.googleapis.com/maps/api/js?key=AIzaSyBbGQXiGt-6UAmOFFdSzYI-byeE7ewBuVM&callback=initializeMap">
    </script>
    <!-- Google analytics -->
