...
<body>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-sm-8 col-sm-offset-2 mb-100 text-center">
                  ...
                  <p class="title-lead mt-10">Whether you’re new to the speaking field or a seasoned pro you’ll connect<br> with old colleagues and make valuable new friends.</p>
               </div>
            </div>
            <!--End row-->
         </div>
            ...
            <div class="row vertical-align">
               ...
               <div class="col-md-6 col-sm-6">
                  <div class="block-video">
                     <iframe src="frontend/http://player.vimeo.com/video/16334844?color=ffffff&portrait=0"></iframe>
                  </div>
               </div>
            </div>
            <!--end of row-->
                     ...
                     <li class="active ">
                        ...
                        <div class="block-detail">
                           ...
                           <div class="block-text">
                              ...
                              <span class="speaker"> <strong>Speaker</strong> : <a href="frontend/#" class="gradient-text ">Adam Blanco</a> </span>
                           </div>
                        </div>
                        <div class="block-detail">
                           ...
                           <div class="block-text">
                              <p>Nihilne te nocturnum praesidium Palati, nihil urbis vigilae, nihil timor populi, nihil concursus velit omnium, nihil hic muntissimus habendi senatus locus, nihil horum ora vultusque moverunt, patere tua consilia non sentis constrictam nihil hic muntissimus.</p>
                              <span class="speaker"> <strong>Speaker</strong> : <a href="frontend/#" class="gradient-text ">Luca Palermo</a> </span>
                           </div>
                        </div>
                        <div class="block-detail">
                        ...
                        <div class="block-detail">
                           ...
                           <div class="block-text">
                              <p>Nihilne te nocturnum praesidium Palati, nihil urbis vigilae, nihil timor populi, nihil concursus velit omnium, nihil hic muntissimus habendi senatus locus, nihil horum ora vultusque moverunt, patere tua consilia non sentis constrictam nihil hic muntissimus.</p>
                              <span class="speaker"> <strong>Speaker</strong> : <a href="frontend/#" class="gradient-text "> Lina Blamberg </a> </span>
                           </div>
                        </div>
                        <div class="block-detail">
                        ...
                        <div class="block-detail">
                           ...
                           <div class="block-text">
                              <p>Nihilne te nocturnum praesidium Palati, nihil urbis vigilae, nihil timor populi, nihil concursus velit omnium, nihil hic muntissimus habendi senatus locus, nihil horum ora vultusque moverunt, patere tua consilia non sentis constrictam nihil hic muntissimus.</p>
                              <span class="speaker"> <strong>Speaker</strong> : <a href="frontend/#" class="gradient-text "> Emilie Lippelt </a> </span>
                           </div>
                        </div>
                     </li>
                     <!--Tab-->
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-sm-12  text-center  front-p">
                  ...
                  <p class="title-lead mt-10 mb-20">27 to 31 July 2017 with over 80 sessions - Cincinnati, Ohio </p>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-sm-8 col-sm-offset-2 mb-130 text-center">
                  ...
                  <p class="title-lead mt-10">If you want more bookings, then reserve your e-ticket for the ride of the year <br> Come join the world’s influencers and get answers. </p>
               </div>
            </div>
            <!--End row-->
         </div>
                     ...
                     <ul class="block-tickets overlap">
                        <li>
                           <ul class="block-ticket ">
                              <li class="block-price"><span class="price"><span class="cur">$</span>120</span><span class="block-type">1 Days ticket</span></li>
                     ...
                     <ul class="block-tickets">
                        <li>
                           <ul class="block-ticket active">
                              <li class="block-price"><span class="price"><span class="cur">$</span>590</span><span class="block-type">All Days ticket</span></li>
            ...
            <div class="row">
               <div class="col-md-6 front-p">
                  <form class="registry-form form" method="post" action="{{ route('store') }}">
                     ...
                     <div class="col-sm-6">
                        <input placeholder="Number of tickets" value="" id="ticket" name="ticket" type="text">
                     </div>
                     <div class="col-sm-6">
         ...
         <div class="container block-contact">
            ...
            <div class="row">
               <div class="col-md-5 col-md-offset-7 col-sm-5 col-sm-offset-7">
                  ...
                  <p class="title-lead mt-10 mb-50">Dear guests, you are welcomed to dine with us at Tasty restaurant. Have a pleasant dining experience. </p>
               </div>
               <div class="col-md-5 col-md-offset-7 col-sm-5 col-sm-offset-7">
                  <div class="block-info-3">
                     <p>
                        ...
                        Fax: (513) 352-6220 <br>
                        Email : <a href="frontend/mailto:contact@events.com" class="gradient-text">contact@events.com</a>
                     </p>
                  </div>
               </div>
            </div>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-sm-8 col-sm-offset-2  text-center mt-50">
                  ...
                  <p><a class="gradient-text" href="frontend/mailto:contact@events.com ">contact@events.com</a></p>
               </div>
            </div>
            <!--End row-->
         </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 ">
                     <ul class="block-legal">
                        ...
                        <li><span><a class="gradient-text scroll" href="frontend/#wrapper">Back To Top</a></span></li>
                     </ul>
                  </div>
               </div>
            </div>
   ...
   <script src="frontend/https://maps.googleapis.com/maps/api/js?key=AIzaSyBbGQXiGt-6UAmOFFdSzYI-byeE7ewBuVM&callback=initializeMap"></script>
   <!-- Google analytics -->
