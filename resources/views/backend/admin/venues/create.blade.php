...
@section('head')
    ...
    <head>
        <meta charset="utf-8">
        <title>Create Venue | {{ config('app.name') }}</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Create New Venue</h4>
                                ...
                                <form action="{{ route('admin.venues.store') }}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control @error('status') is-invalid @enderror"
                                                    ...
                                                    <option value="maintenance"
                                                        {{ old('status') == 'maintenance' ? 'selected' : '' }}>Under
                                                        Maintenance</option>
                                                </select>
                                                @error('status')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                            rows="4" placeholder="Enter venue description (optional)" maxlength="200">{{ old('description') }}</textarea>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="border p-3 rounded">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <img src="{{ url('') }}/dist/assets/images/venues/default-venue.jpg"
                                                ...
                                                <div class="col">
                                                    <div class="custom-file">
                                                        ...
                                                        <small class="text-muted">Upload venue image (JPEG, PNG, JPG, GIF -
                                                            max 2MB)</small>
                                                        @error('image')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="mdi mdi-content-save me-2"></i> Create Venue
                                        </button>
