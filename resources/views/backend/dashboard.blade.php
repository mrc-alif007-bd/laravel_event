                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <li class="feed-item">
                                        <div class="feed-item-list">
                                            ...
                                            <span class="activity-text">At vero eos et accusamus et iusto odio
                                                dignissimos ducimus qui deleniti atque...<a href="{{url('')}}/#"
                                ...
                                <div class="text-center">
                                    <a href="{{url('')}}/#" class="btn btn-primary">Load More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        <div class="py-4">
                                            ...
                                            <div class="mt-4">
                                                <a href="{{url('')}}/" class="btn btn-primary btn-sm">Chack Status</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="text-center text-white py-4">
                                            ...
                                            <p class="text-white-50 mb-0">At solmen va esser necessi far uniform
                                                myth... <a href="{{url('')}}/#" class="text-white">View more</a></p>
                                        </div>
                                    </div>
                                </div>
